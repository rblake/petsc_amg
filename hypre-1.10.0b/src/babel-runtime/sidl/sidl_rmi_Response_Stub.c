 ...
 * Revision:      @(#) $Id: sidl_rmi_Response_Stub.c,v 1.4 2005/11/14 21:20:26 painter Exp $
...
{
  return sidl_rmi_Response__remoteConnect(url, _ex);
}
...
sidl_bool
sidl_rmi_Response_done(
  /* in */ sidl_rmi_Response self,
  /* out */ sidl_BaseInterface *_ex)
{
  return (*self->d_epv->f_done)(
    self->d_object,
    _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.Response",
      (void*)sidl_rmi_Response__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  if (!strcmp(name, "sidl.rmi._Response")) {
    cast = (void*) s0;
...
remote_sidl_rmi__Response_addRef(
  /* in */ struct sidl_rmi__Response__object* self /* TLD */)
{
...
remote_sidl_rmi__Response_queryInt(
  /* in */ struct sidl_rmi__Response__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
/* REMOTE METHOD STUB:done */
static sidl_bool
remote_sidl_rmi__Response_done(
  /* in */ struct sidl_rmi__Response__object* self /* TLD */,
  /* out */ struct sidl_BaseInterface__object* *_ex)
{
  sidl_BaseInterface *_ex2 =_ex;
...
static void sidl_rmi__Response__init_remote_epv(void)
{
  ...
  epv->f_queryInt                = remote_sidl_rmi__Response_queryInt;
  ...
  epv->f_unpackFcomplex          = remote_sidl_rmi__Response_unpackFcomplex;
  epv->f_unpackDcomplex          = remote_sidl_rmi__Response_unpackDcomplex;
  epv->f_unpackString            = remote_sidl_rmi__Response_unpackString;
  epv->f_getExceptionThrown      = remote_sidl_rmi__Response_getExceptionThrown;
  epv->f_done                    = remote_sidl_rmi__Response_done;
...
static struct sidl_rmi_Response__object*
sidl_rmi_Response__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct sidl_rmi__Response__object* self;
  ...
  return sidl_rmi_Response__cast(self);
}
