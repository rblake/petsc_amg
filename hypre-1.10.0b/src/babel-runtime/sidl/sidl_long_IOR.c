/*
 * File:        sidl_long_IOR.c
 * Copyright:   (c) 2001 The Regents of the University of California
 * Revision:    @(#) $Revision: 1.6 $
 * Date:        $Date: 2005/11/14 21:20:26 $
 * Description: long array implementation
...
static int64_t const sidl_long__array_zero = 0;
 ...
 */
static void
sidl_long__array_bdestroy(struct sidl_long__array* array)
{
  if (array) {
    memset(array, 0, sizeof(struct sidl_long__array) +
 ...
 */
static void
sidl_long__array_destroy(struct sidl_long__array* array)
{
  if (array) {
    ...
    sidl_long__array_bdestroy(array);
  }
}
 ...
 */
static void
sidl_long__array_rdestroy(struct sidl_long__array* array)
{ }
/**
 ...
 */
static void
sidl_long__array_sdestroy(struct sidl_long__array* array)
{
  if (array) {
    static const int arraySize = sizeof(struct sidl_long__array)
      + (sizeof(int32_t) - (sizeof(struct sidl_long__array)
                        % sizeof(int32_t))) % sizeof(int32_t);
    struct sidl_long__array **orig;
    orig = (struct sidl_long__array **)((char *)array + arraySize +
      3 * sizeof(int32_t)*array->d_metadata.d_dimen);
    if (*orig) {
      sidl_long__array_deleteRef(*orig);
      *orig = NULL;
    }
    sidl_long__array_bdestroy(array);
  }
...
sidl_long__array_smartCp(struct sidl_long__array* array)
{
 ...
 */
static struct sidl_long__array*
sidl_long__array_borrowSmartCp(struct sidl_long__array* array)
{
  struct sidl_long__array* copy = NULL;
  if (array) {
    if (sidl_long__array_isColumnOrder(array)) {
      copy = sidl_long__array_createCol(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    else {
      copy = sidl_long__array_createRow(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    sidl_long__array_copy(array, copy);
  }
  return copy;
}
...
long_arrayType(void)
{
  return sidl_long_array;
}
/**
 * Virtual function table for rarrays.
 */

static const struct sidl__array_vtable rarray_long_vtable = {
  (void (*)(struct sidl__array *))sidl_long__array_rdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_long__array_borrowSmartCp,
  long_arrayType
};
/**
...
static const struct sidl__array_vtable normal_long_vtable = {
  (void (*)(struct sidl__array *))sidl_long__array_destroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_long__array_smartCp,
  long_arrayType
};
/**
...
static const struct sidl__array_vtable borrowed_long_vtable = {
  (void (*)(struct sidl__array *))sidl_long__array_bdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_long__array_borrowSmartCp,
  long_arrayType
};
...
static const struct sidl__array_vtable sliced_long_vtable = {
  (void (*)(struct sidl__array *))sidl_long__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_long__array_smartCp,
  long_arrayType
};
...
static const struct sidl__array_vtable bsliced_long_vtable = {
  (void (*)(struct sidl__array *))sidl_long__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_long__array_borrowSmartCp,
  long_arrayType
         ...
         struct sidl_long__array *orig)
{
  static const int arraySize = sizeof(struct sidl_long__array)
    + (sizeof(int32_t) - (sizeof(struct sidl_long__array)
                      % sizeof(int32_t))) % sizeof(int32_t);
  struct sidl_long__array *result = (struct sidl_long__array *)
    malloc(arraySize + 3 * sizeof(int32_t) * dimen +
           (orig ? sizeof(struct sidl_long__array *) : 0));
  ...
  if (orig) {
    struct sidl_long__array **ref;
    ref = (struct sidl_long__array **)
      ((char *)result + arraySize + 3 * sizeof(int32_t)*dimen);
    *ref = orig;
    sidl_long__array_addRef(orig);
    result->d_metadata.d_vtable = &sliced_long_vtable;
  }
  else {
    result->d_metadata.d_vtable = &normal_long_vtable;
  }
...
{
  int32_t size=1, i;
  struct sidl_long__array *result = newArray(dimen, lower, upper, NULL);
  for(i = 0; i < dimen; ++i) {
    result->d_metadata.d_stride[i] = size;
    size *= (1 + upper[i] - lower[i]);
  }
  size *= sizeof(int64_t);
  result->d_firstElement = (int64_t *)malloc(size);
...
int32_t lower[], int32_t upper[], int32_t stride[])
{
  ...
  sidl_array->d_metadata.d_lower = lower;
  sidl_array->d_metadata.d_vtable = &rarray_long_vtable;
  sidl_array->d_metadata.d_refcount = 1;
  sidl_array->d_firstElement = (int64_t *)c_array; 
}
...
sidl_long__array_create1d(int32_t len)
{
  ...
  --len;
  return sidl_long__array_createCol(1, &zero, &len);
}
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (int64_t *)malloc(len*sizeof(int64_t));
      dest = (int64_t * restrict)(result->d_firstElement);
      while (len--) {
        *dest = COPY_VALUE(*src);
        ++dest;
        ++src;
    ...
    result = sidl_long__array_create1d(len);
  }
  return result;
}
...
sidl_long__array_create2dCol(int32_t m, int32_t n)
{
  ...
  upper[0] = m-1;
  upper[1] = n-1;
  return sidl_long__array_createCol(2, zero, upper);
}
...
sidl_long__array_create2dRow(int32_t m, int32_t n)
{
  ...
  upper[0] = m-1;
  upper[1] = n-1;
  return sidl_long__array_createRow(2, zero, upper);
}
 ...
 */
static int
goodSliceArgs(struct sidl_long__array* src,
               int32_t       dimen,
...
sidl_long__array_slice(struct sidl_long__array *src,
                       ...
                       const int32_t *newStart)
{
  struct sidl_long__array *result = NULL;
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_metadata.d_vtable->d_smartcopy ==
        ...
        result->d_metadata.d_vtable = &bsliced_long_vtable;
      }
    }
  }
  return result;
                        ...
                        const int32_t  stride[])
{
  ...
  result->d_metadata.d_vtable = &borrowed_long_vtable;
  return result;
}
...
{
  return (struct sidl_long__array *)
...
{
  return (array &&
          (sidl_long_array == ((array->d_vtable->d_arraytype)())))
                      ...
                      const int32_t i7)
{
  if (array) {
    ...
    case 1: return sidl_long__array_get1(array, i1);
    case 2: return sidl_long__array_get2(array, i1, i2);
    case 3: return sidl_long__array_get3(array, i1, i2, i3);
    case 4: return sidl_long__array_get4(array, i1, i2, i3, i4);
    case 5: return sidl_long__array_get5(array, i1, i2, i3, i4, i5);
    case 6: return sidl_long__array_get6(array, i1, i2, i3, i4, i5, i6);
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
...
{
  if (array) {
    int64_t *result = array->d_firstElement;
    int32_t i = 0;
                      ...
                      const int64_t value)
{
  if (array) {
    switch(array->d_metadata.d_dimen) {
    case 1: sidl_long__array_set1(array, i1, value); break;
    case 2: sidl_long__array_set2(array, i1, i2, value); break;
    case 3: sidl_long__array_set3(array, i1, i2, i3, value); break;
    case 4: sidl_long__array_set4(array, i1, i2, i3, i4, value); break;
    case 5: sidl_long__array_set5(array, i1, i2, i3, i4, i5, value); break;
    case 6: sidl_long__array_set6(array, i1, i2, i3, i4, i5, i6, value); break;
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
                            ...
                            struct sidl_long__array* dest)
{
  if (src && dest && (src != dest) &&
    ...
    if (overlap) {
      register int64_t const * restrict srcFirst =
        src->d_firstElement;
      register int64_t * restrict destFirst =
        dest->d_firstElement;
      register int32_t i;
                        ...
                        int                    ordering)
{
  ...
  if (src && (src->d_metadata.d_dimen == dimen)) {
    ...
    case sidl_column_major_order:
      if (sidl_long__array_isColumnOrder(src)) {
        sidl_long__array_addRef(src);
        result = src;
      }
      else {
        result = sidl_long__array_createCol
          (dimen, src->d_metadata.d_lower, src->d_metadata.d_upper);
        sidl_long__array_copy(src, result);
      }
      break;
    case sidl_row_major_order:
      if (sidl_long__array_isRowOrder(src)) {
        sidl_long__array_addRef(src);
        result = src;
      }
      else {
        result = sidl_long__array_createRow
          (dimen, src->d_metadata.d_lower, src->d_metadata.d_upper);
        sidl_long__array_copy(src, result);
      }
      break;
