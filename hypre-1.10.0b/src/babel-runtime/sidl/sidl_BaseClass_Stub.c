 ...
 * Revision:      @(#) $Id: sidl_BaseClass_Stub.c,v 1.5 2005/11/14 21:20:23 painter Exp $
...
static sidl_BaseClass sidl_BaseClass__remote(const char* url,
...
{
  return sidl_BaseClass__remote(url, _ex);
}
...
{
  return sidl_BaseClass__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.BaseClass",
      (void*)sidl_BaseClass__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  else if(sidl_BaseClass_isType(self, name)) {
...
remote_sidl_BaseClass_addRef(
  /* in */ struct sidl_BaseClass__object* self /* TLD */)
{
...
static struct sidl_BaseClass__object*
sidl_BaseClass__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  struct sidl_BaseClass__object* self;
...
static struct sidl_BaseClass__object*
sidl_BaseClass__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidl_BaseClass__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "sidl.BaseClass", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_BaseClass__object*) malloc(
      sizeof(struct sidl_BaseClass__object));
