 ...
 * Revision:      @(#) $Id: sidl_BaseInterface_Stub.c,v 1.5 2005/11/14 21:20:23 painter Exp $
...
static struct sidl_BaseInterface__object* 
  sidl_BaseInterface__remoteConnect(const char* url, sidl_BaseInterface *_ex);
static struct sidl_BaseInterface__object* 
...
sidl_BaseInterface
sidl_BaseInterface__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_BaseInterface__remoteConnect(url, _ex);
}
...
sidl_BaseInterface__cast(
  void* obj)
{
  sidl_BaseInterface cast = NULL;

  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.BaseInterface",
      (void*)sidl_BaseInterface__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_BaseInterface) (*base->d_epv->f__cast)(
      base->d_object,
      "sidl.BaseInterface");
  }
...
{
  return (struct 
    sidl_BaseInterface__array*)sidl_interface__array_createCol(dimen, lower,
    upper);
}
...
{
  return (struct 
    sidl_BaseInterface__array*)sidl_interface__array_createRow(dimen, lower,
    upper);
}
...
{
  return (struct sidl_BaseInterface__array*)sidl_interface__array_create1d(len);
}
...
{
  return (struct 
    sidl_BaseInterface__array*)sidl_interface__array_create1dInit(len,
...
{
  return (struct sidl_BaseInterface__array*)sidl_interface__array_create2dCol(m,
    n);
}
...
{
  return (struct sidl_BaseInterface__array*)sidl_interface__array_create2dRow(m,
    n);
}
...
{
  return (struct sidl_BaseInterface__array*)sidl_interface__array_borrow(
...
const char* name)
{
  ...
  if (!strcmp(name, "sidl._BaseInterface")) {
    cast = (void*) s0;
...
remote_sidl__BaseInterface_addRef(
  /* in */ struct sidl__BaseInterface__object* self /* TLD */)
{
...
static struct sidl_BaseInterface__object*
remote_sidl__BaseInterface_queryInt(
  /* in */ struct sidl__BaseInterface__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void sidl__BaseInterface__init_remote_epv(void)
{
  ...
  epv->f_queryInt          = remote_sidl__BaseInterface_queryInt;
...
sidl_BaseInterface__remoteConnect(const char *url, sidl_BaseInterface *_ex)
{
  ...
  return sidl_BaseInterface__cast(self);
}
