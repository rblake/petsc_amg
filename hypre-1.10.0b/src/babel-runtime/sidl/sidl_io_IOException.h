 ...
 * Revision:      @(#) $Id: sidl_io_IOException.h,v 1.4 2005/11/14 21:20:25 painter Exp $
 ...
 */
struct sidl_io_IOException__object*
sidl_io_IOException__create(void);

/**
 * RMI constructor function for the class.
 */
sidl_io_IOException
sidl_io_IOException__createRemote(const char *, sidl_BaseInterface *_ex);
