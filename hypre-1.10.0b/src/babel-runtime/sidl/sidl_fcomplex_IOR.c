/*
 * File:        sidl_fcomplex_IOR.c
 * Copyright:   (c) 2001 The Regents of the University of California
 * Revision:    @(#) $Revision: 1.6 $
 * Date:        $Date: 2005/11/14 21:20:25 $
 * Description: fcomplex array implementation
...
static struct sidl_fcomplex const sidl_fcomplex__array_zero = {0, 0};
 ...
 */
static void
sidl_fcomplex__array_bdestroy(struct sidl_fcomplex__array* array)
{
  if (array) {
    memset(array, 0, sizeof(struct sidl_fcomplex__array) +
 ...
 */
static void
sidl_fcomplex__array_destroy(struct sidl_fcomplex__array* array)
{
  if (array) {
#ifdef DESTROY_VALUES_TOO
    struct sidl_fcomplex *ptr = array->d_firstElement;
    int32_t i;
    int32_t size = 1;
    ...
    sidl_fcomplex__array_bdestroy(array);
  }
}
 ...
 */
static void
sidl_fcomplex__array_rdestroy(struct sidl_fcomplex__array* array)
{ }
/**
 ...
 */
static void
sidl_fcomplex__array_sdestroy(struct sidl_fcomplex__array* array)
{
  if (array) {
    static const int arraySize = sizeof(struct sidl_fcomplex__array)
      + (sizeof(int32_t) - (sizeof(struct sidl_fcomplex__array)
                        % sizeof(int32_t))) % sizeof(int32_t);
    struct sidl_fcomplex__array **orig;
    orig = (struct sidl_fcomplex__array **)((char *)array + arraySize +
      3 * sizeof(int32_t)*array->d_metadata.d_dimen);
    if (*orig) {
      sidl_fcomplex__array_deleteRef(*orig);
      *orig = NULL;
    }
    sidl_fcomplex__array_bdestroy(array);
  }
...
sidl_fcomplex__array_smartCp(struct sidl_fcomplex__array* array)
{
 ...
 */
static struct sidl_fcomplex__array*
sidl_fcomplex__array_borrowSmartCp(struct sidl_fcomplex__array* array)
{
  struct sidl_fcomplex__array* copy = NULL;
  if (array) {
    if (sidl_fcomplex__array_isColumnOrder(array)) {
      copy = sidl_fcomplex__array_createCol(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    else {
      copy = sidl_fcomplex__array_createRow(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    sidl_fcomplex__array_copy(array, copy);
  }
  return copy;
}
 ...
 */
static int32_t
fcomplex_arrayType(void)
{
  return sidl_fcomplex_array;
}
/**
 * Virtual function table for rarrays.
 */

static const struct sidl__array_vtable rarray_fcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_fcomplex__array_rdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_fcomplex__array_borrowSmartCp,
  fcomplex_arrayType
};
/**
...
static const struct sidl__array_vtable normal_fcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_fcomplex__array_destroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_fcomplex__array_smartCp,
  fcomplex_arrayType
};
/**
...
static const struct sidl__array_vtable borrowed_fcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_fcomplex__array_bdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_fcomplex__array_borrowSmartCp,
  fcomplex_arrayType
};
...
static const struct sidl__array_vtable sliced_fcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_fcomplex__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_fcomplex__array_smartCp,
  fcomplex_arrayType
};
...
static const struct sidl__array_vtable bsliced_fcomplex_vtable = {
  (void (*)(struct sidl__array *))sidl_fcomplex__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_fcomplex__array_borrowSmartCp,
  fcomplex_arrayType
         ...
         struct sidl_fcomplex__array *orig)
{
  static const int arraySize = sizeof(struct sidl_fcomplex__array)
    + (sizeof(int32_t) - (sizeof(struct sidl_fcomplex__array)
                      % sizeof(int32_t))) % sizeof(int32_t);
  struct sidl_fcomplex__array *result = (struct sidl_fcomplex__array *)
    malloc(arraySize + 3 * sizeof(int32_t) * dimen +
           (orig ? sizeof(struct sidl_fcomplex__array *) : 0));
  ...
  if (orig) {
    struct sidl_fcomplex__array **ref;
    ref = (struct sidl_fcomplex__array **)
      ((char *)result + arraySize + 3 * sizeof(int32_t)*dimen);
    *ref = orig;
    sidl_fcomplex__array_addRef(orig);
    result->d_metadata.d_vtable = &sliced_fcomplex_vtable;
  }
  else {
    result->d_metadata.d_vtable = &normal_fcomplex_vtable;
  }
...
{
  int32_t size=1, i;
  struct sidl_fcomplex__array *result = newArray(dimen, lower, upper, NULL);
  for(i = 0; i < dimen; ++i) {
    result->d_metadata.d_stride[i] = size;
    size *= (1 + upper[i] - lower[i]);
  }
  size *= sizeof(struct sidl_fcomplex);
  result->d_firstElement = (struct sidl_fcomplex *)malloc(size);
...
int32_t lower[], int32_t upper[], int32_t stride[])
{
  ...
  sidl_array->d_metadata.d_lower = lower;
  sidl_array->d_metadata.d_vtable = &rarray_fcomplex_vtable;
  sidl_array->d_metadata.d_refcount = 1;
  sidl_array->d_firstElement = (struct sidl_fcomplex *)c_array; 
}
...
sidl_fcomplex__array_create1d(int32_t len)
{
  ...
  --len;
  return sidl_fcomplex__array_createCol(1, &zero, &len);
}
                                  ...
                                  const struct sidl_fcomplex* data)
{
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      const struct sidl_fcomplex * restrict src =
        (const struct sidl_fcomplex * restrict)data;
      struct sidl_fcomplex * restrict dest;
      result->d_metadata.d_stride[0] = 1;
      result->d_firstElement =
        (struct sidl_fcomplex *)malloc(len*sizeof(struct sidl_fcomplex));
      dest = (struct sidl_fcomplex * restrict)(result->d_firstElement);
      while (len--) {
        *dest = COPY_VALUE(*src);
        ++dest;
        ++src;
    ...
    result = sidl_fcomplex__array_create1d(len);
  }
  return result;
}
...
sidl_fcomplex__array_create2dCol(int32_t m, int32_t n)
{
  ...
  upper[0] = m-1;
  upper[1] = n-1;
  return sidl_fcomplex__array_createCol(2, zero, upper);
}
...
sidl_fcomplex__array_create2dRow(int32_t m, int32_t n)
{
  ...
  upper[0] = m-1;
  upper[1] = n-1;
  return sidl_fcomplex__array_createRow(2, zero, upper);
}
 ...
 */
static int
goodSliceArgs(struct sidl_fcomplex__array* src,
               int32_t       dimen,
...
sidl_fcomplex__array_slice(struct sidl_fcomplex__array *src,
                           ...
                           const int32_t *newStart)
{
  struct sidl_fcomplex__array *result = NULL;
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_metadata.d_vtable->d_smartcopy ==
        ...
        result->d_metadata.d_vtable = &bsliced_fcomplex_vtable;
      }
    }
  }
  return result;
                            ...
                            const int32_t  stride[])
{
  ...
  result->d_metadata.d_vtable = &borrowed_fcomplex_vtable;
  return result;
}
...
{
  return (struct sidl_fcomplex__array *)
...
{
  return (array &&
          (sidl_fcomplex_array == ((array->d_vtable->d_arraytype)())))
                          ...
                          const int32_t i1)
{
  ...
  return sidl_fcomplex__array_zero;
}
                          ...
                          const int32_t i7)
{
  if (array) {
    ...
    case 1: return sidl_fcomplex__array_get1(array, i1);
    case 2: return sidl_fcomplex__array_get2(array, i1, i2);
    case 3: return sidl_fcomplex__array_get3(array, i1, i2, i3);
    case 4: return sidl_fcomplex__array_get4(array, i1, i2, i3, i4);
    case 5: return sidl_fcomplex__array_get5(array, i1, i2, i3, i4, i5);
    case 6: return sidl_fcomplex__array_get6(array, i1, i2, i3, i4, i5, i6);
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
...
{
  if (array) {
    struct sidl_fcomplex *result = array->d_firstElement;
    int32_t i = 0;
                          ...
                          const struct sidl_fcomplex value)
{
  if (array) {
    switch(array->d_metadata.d_dimen) {
    case 1: sidl_fcomplex__array_set1(array, i1, value); break;
    case 2: sidl_fcomplex__array_set2(array, i1, i2, value); break;
    case 3: sidl_fcomplex__array_set3(array, i1, i2, i3, value); break;
    case 4: sidl_fcomplex__array_set4(array, i1, i2, i3, i4, value); break;
    case 5: sidl_fcomplex__array_set5(array, i1, i2, i3, i4, i5, value); break;
    case 6: sidl_fcomplex__array_set6(array, i1, i2, i3, i4, i5, i6, value); break;
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
                                ...
                                struct sidl_fcomplex__array* dest)
{
  if (src && dest && (src != dest) &&
    ...
    if (overlap) {
      register struct sidl_fcomplex const * restrict srcFirst =
        src->d_firstElement;
      register struct sidl_fcomplex * restrict destFirst =
        dest->d_firstElement;
      register int32_t i;
                            ...
                            int                    ordering)
{
  ...
  if (src && (src->d_metadata.d_dimen == dimen)) {
    ...
    case sidl_column_major_order:
      if (sidl_fcomplex__array_isColumnOrder(src)) {
        sidl_fcomplex__array_addRef(src);
        result = src;
      }
      else {
        result = sidl_fcomplex__array_createCol
          (dimen, src->d_metadata.d_lower, src->d_metadata.d_upper);
        sidl_fcomplex__array_copy(src, result);
      }
      break;
    case sidl_row_major_order:
      if (sidl_fcomplex__array_isRowOrder(src)) {
        sidl_fcomplex__array_addRef(src);
        result = src;
      }
      else {
        result = sidl_fcomplex__array_createRow
          (dimen, src->d_metadata.d_lower, src->d_metadata.d_upper);
        sidl_fcomplex__array_copy(src, result);
      }
      break;
