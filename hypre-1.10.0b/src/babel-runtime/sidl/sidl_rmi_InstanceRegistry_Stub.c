 ...
 * Revision:      @(#) $Id: sidl_rmi_InstanceRegistry_Stub.c,v 1.4 2005/11/14 21:20:26 painter Exp $
...
sidl_rmi_InstanceRegistry__create()
{
  return (*(_getExternals()->createObject))();
}

static sidl_rmi_InstanceRegistry sidl_rmi_InstanceRegistry__remote(const char* 
...
{
  return sidl_rmi_InstanceRegistry__remote(url, _ex);
}

static struct sidl_rmi_InstanceRegistry__object* 
  sidl_rmi_InstanceRegistry__remoteConnect(const char* url,
  sidl_BaseInterface *_ex);
static struct sidl_rmi_InstanceRegistry__object* 
...
{
  return sidl_rmi_InstanceRegistry__remoteConnect(url, _ex);
}
...
sidl_rmi_InstanceRegistry_removeInstance(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return (_getSEPV()->f_removeInstance)(
    instanceID,
    _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.rmi.InstanceRegistry",
      (void*)sidl_rmi_InstanceRegistry__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  else if(sidl_rmi_InstanceRegistry_isType(self, name)) {
...
remote_sidl_rmi_InstanceRegistry_addRef(
  /* in */ struct sidl_rmi_InstanceRegistry__object* self /* TLD */)
{
...
remote_sidl_rmi_InstanceRegistry_queryInt(
  /* in */ struct sidl_rmi_InstanceRegistry__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void sidl_rmi_InstanceRegistry__init_remote_epv(void)
{
  ...
  epv->f_queryInt          = remote_sidl_rmi_InstanceRegistry_queryInt;
...
static struct sidl_rmi_InstanceRegistry__object*
sidl_rmi_InstanceRegistry__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidl_rmi_InstanceRegistry__object* self;
