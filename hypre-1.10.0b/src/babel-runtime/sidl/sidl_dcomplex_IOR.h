...
/**
 * The data structure for multi-dimensional arrays for sidl dcomplex.
...
struct sidl_dcomplex__array {
  ...
  struct sidl_dcomplex *d_firstElement;
};
...
#endif
#endif /* included_sidl_dcomplex_IOR_h */
