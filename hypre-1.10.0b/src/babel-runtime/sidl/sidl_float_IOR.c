 ...
 */
static void
sidl_float__array_rdestroy(struct sidl_float__array* array)
{ }
/**
...
sidl_float__array_borrowSmartCp(struct sidl_float__array* array)
{
  ...
  if (array) {
    if (sidl_float__array_isColumnOrder(array)) {
      copy = sidl_float__array_createCol(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
    else {
      copy = sidl_float__array_createRow(array->d_metadata.d_dimen,
                                                array->d_metadata.d_lower,
                                                array->d_metadata.d_upper);
    }
 ...
 */
static int32_t
float_arrayType(void)
{
  return sidl_float_array;
}
/**
 * Virtual function table for rarrays.
 */

static const struct sidl__array_vtable rarray_float_vtable = {
  (void (*)(struct sidl__array *))sidl_float__array_rdestroy,
...
static const struct sidl__array_vtable normal_float_vtable = {
  (void (*)(struct sidl__array *))sidl_float__array_destroy,
  (struct sidl__array *(*)(struct sidl__array *))
...
static const struct sidl__array_vtable borrowed_float_vtable = {
  (void (*)(struct sidl__array *))sidl_float__array_bdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_float__array_borrowSmartCp,
  float_arrayType
};
...
static const struct sidl__array_vtable sliced_float_vtable = {
  (void (*)(struct sidl__array *))sidl_float__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_float__array_smartCp,
  float_arrayType
};
...
static const struct sidl__array_vtable bsliced_float_vtable = {
  (void (*)(struct sidl__array *))sidl_float__array_sdestroy,
  (struct sidl__array *(*)(struct sidl__array *))
    sidl_float__array_borrowSmartCp,
  float_arrayType
         ...
         struct sidl_float__array *orig)
{
  ...
  if (orig) {
    ...
    *ref = orig;
    ...
    result->d_metadata.d_vtable = &sliced_float_vtable;
  }
  else {
    result->d_metadata.d_vtable = &normal_float_vtable;
  }
...
int32_t lower[], int32_t upper[], int32_t stride[])
{
  ...
  sidl_array->d_metadata.d_lower = lower;
  sidl_array->d_metadata.d_vtable = &rarray_float_vtable;
  sidl_array->d_metadata.d_refcount = 1;
  sidl_array->d_firstElement = (float *)c_array; 
}
                               ...
                               const float* data)
{
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      dest = (float * restrict)(result->d_firstElement);
      while (len--) {
        *dest = COPY_VALUE(*src);
        ++dest;
        ++src;
    ...
    result = sidl_float__array_create1d(len);
  }
  return result;
}
  ...
  if (goodSliceArgs(src, dimen, srcStart, srcStride, newStart, numElem)) {
    ...
    if (result) {
      ...
      if (src->d_metadata.d_vtable->d_smartcopy ==
        ...
        result->d_metadata.d_vtable = &bsliced_float_vtable;
      }
    }
  }
  return result;
                         ...
                         const int32_t  stride[])
{
  ...
  result->d_metadata.d_vtable = &borrowed_float_vtable;
  return result;
}
...
{
  return (struct sidl_float__array *)
...
{
  return (array &&
          (sidl_float_array == ((array->d_vtable->d_arraytype)())))
                       ...
                       const int32_t i7)
{
  if (array) {
    ...
    case 4: return sidl_float__array_get4(array, i1, i2, i3, i4);
    case 5: return sidl_float__array_get5(array, i1, i2, i3, i4, i5);
    case 6: return sidl_float__array_get6(array, i1, i2, i3, i4, i5, i6);
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
                       ...
                       const float value)
{
  if (array) {
    ...
    case 4: sidl_float__array_set4(array, i1, i2, i3, i4, value); break;
    case 5: sidl_float__array_set5(array, i1, i2, i3, i4, i5, value); break;
    case 6: sidl_float__array_set6(array, i1, i2, i3, i4, i5, i6, value); break;
    case 7:
      {
        /* unserialize array bounds checking (i.e. avoid strict left to right */
        /* evaluation of && which serializes evaluation) */
