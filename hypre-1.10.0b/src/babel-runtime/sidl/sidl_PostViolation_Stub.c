 ...
 * Revision:      @(#) $Id: sidl_PostViolation_Stub.c,v 1.4 2005/11/14 21:20:24 painter Exp $
...
sidl_PostViolation
sidl_PostViolation__create()
{
  return (*(_getExternals()->createObject))();
}

static sidl_PostViolation sidl_PostViolation__remote(const char* url,
...
{
  return sidl_PostViolation__remote(url, _ex);
}

static struct sidl_PostViolation__object* 
  sidl_PostViolation__remoteConnect(const char* url, sidl_BaseInterface *_ex);
static struct sidl_PostViolation__object* 
...
{
  return sidl_PostViolation__remoteConnect(url, _ex);
}
  ...
  void* obj)
{
  ...
  if(!connect_loaded) {
    sidl_rmi_ConnectRegistry_registerConnect("sidl.PostViolation",
      (void*)sidl_PostViolation__IHConnect);
    connect_loaded = 1;
  }
  if (obj != NULL) {
...
const char* name)
{
  ...
  else if(sidl_PostViolation_isType(self, name)) {
...
remote_sidl_PostViolation_addRef(
  /* in */ struct sidl_PostViolation__object* self /* TLD */)
{
...
remote_sidl_PostViolation_queryInt(
  /* in */ struct sidl_PostViolation__object* self /* TLD */,
  /* in */ const char* name)
{
  /* FIXME  need to think through all of these special cases */
...
static void sidl_PostViolation__init_remote_epv(void)
{
  ...
  epv->f_queryInt          = remote_sidl_PostViolation_queryInt;
...
static struct sidl_PostViolation__object*
sidl_PostViolation__remote(const char *url, sidl_BaseInterface *_ex)
{
  struct sidl_PostViolation__object* self;
  ...
  sidl_rmi_InstanceHandle instance = 
    sidl_rmi_ProtocolFactory_createInstance(url, "sidl.PostViolation", _ex );
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_PostViolation__object*) malloc(
      sizeof(struct sidl_PostViolation__object));
