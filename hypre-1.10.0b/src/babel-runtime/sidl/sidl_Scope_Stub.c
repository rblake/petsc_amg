 ...
 * Revision:      @(#) $Id: sidl_Scope_Stub.c,v 1.5 2005/11/14 21:20:25 painter Exp $
...
{
  return (struct sidl_Scope__array*)sidl_int__array_create1d(len);
}
...
{
  return (struct sidl_Scope__array*)sidl_int__array_create2dCol(m, n);
}
...
{
  return (struct sidl_Scope__array*)sidl_int__array_create2dRow(m, n);
}
...
{
  return (struct sidl_Scope__array*)sidl_int__array_borrow(
...
{
  return (struct sidl_Scope__array*)
