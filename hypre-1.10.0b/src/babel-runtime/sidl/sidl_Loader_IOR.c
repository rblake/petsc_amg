 ...
 * Revision:      @(#) $Id: sidl_Loader_IOR.c,v 1.5 2005/11/14 21:20:24 painter Exp $
...
extern void sidl_Loader__call_load(void);
#ifdef __cplusplus
}
#endif
  ...
  struct sidl_Loader__object* self)
{
  ...
  s0->d_epv    = &s_new_epv__sidl_loader;
