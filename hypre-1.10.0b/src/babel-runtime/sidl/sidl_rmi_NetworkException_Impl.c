 ...
 * Revision:      @(#) $Id: sidl_rmi_NetworkException_Impl.c,v 1.5 2005/11/14 21:20:26 painter Exp $
...
char * impl_sidl_rmi_NetworkException_fgetURL_sidl_SIDLException(struct 
...
char * impl_sidl_rmi_NetworkException_fgetURL_sidl_ClassInfo(struct 
...
char * impl_sidl_rmi_NetworkException_fgetURL_sidl_io_IOException(struct 
...
char * impl_sidl_rmi_NetworkException_fgetURL_sidl_rmi_NetworkException(struct 
...
char * impl_sidl_rmi_NetworkException_fgetURL_sidl_BaseInterface(struct 
...
char * impl_sidl_rmi_NetworkException_fgetURL_sidl_BaseException(struct 
...
char * impl_sidl_rmi_NetworkException_fgetURL_sidl_BaseClass(struct 
