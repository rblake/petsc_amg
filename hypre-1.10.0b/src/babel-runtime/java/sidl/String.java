...
/**
 * Class <code>String</code> contains inner classes that
...
public class String {
  ...
  public static class Holder {
    private java.lang.String d_obj;
  ...
  /**
   * Define a one dimensional array of type <code>java.lang.String</code>
  ...
  public static class Array extends gov.llnl.sidl.BaseArray {
     ...
     */
    static {
      gov.llnl.sidl.BaseClass._registerNatives("sidl.String");
    }
     ...
     */
    public native java.lang.String _get(
    ...
    public native void _set(
      int i, int j, int k, int l, int m, int n, int o, java.lang.String value);
  ...
  public Array _dcast() {
    try{ 
      int dimen = _dim();
      sidl.String.Array ret = null;
      switch (dimen) {
      case 1: 

	ret = (Array) new sidl.String.Array1(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 2:
        ret = (Array) new sidl.String.Array2(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 3:
        ret = (Array) new sidl.String.Array3(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 4:
        ret = (Array) new sidl.String.Array4(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 5:
        ret = (Array) new sidl.String.Array5(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 6:
        ret = (Array) new sidl.String.Array6(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 7:
        ret = (Array) new sidl.String.Array7(get_ior_pointer(),true);
         _addRef();
        return ret;
      default:
        return null;
  ...
  public static class Array1 extends Array {
     ...
     */
    public Array1(java.lang.String[] array) {
      super();
      fromArray(array);
    }
    ...
    */
    ...
    public java.lang.String[] toArray() {
      ...
      if (!isNull()) {
        ...
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new java.lang.String[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
        }
      }
  ...
  /**
   * Define a two dimensional array of type <code>java.lang.String</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array2 extends Array {
     ...
     * index out of range exception will be thrown if the bounds are invalid.
     */
    public Array2(java.lang.String[][] array) {
      super();
      fromArray(array);
    }
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public java.lang.String _get(int i, int j) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, java.lang.String value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, java.lang.String value) {
      checkBounds(i, j);
      _set(i, j, 0, 0, 0, 0, 0, value);
    }
    ...
    public java.lang.String[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new java.lang.String[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new java.lang.String[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
  ...
  /**
   * Define a three dimensional array of type <code>java.lang.String</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array3 extends Array {
     ...
     * index out of range exception will be thrown if the bounds are invalid.
     */
    public Array3(java.lang.String[][][] array) {
      super();
      fromArray(array);
    }
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public java.lang.String _get(int i, int j, int k) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public java.lang.String get(int i, int j, int k) {
      checkBounds(i, j, k);
      return _get(i, j, k, 0, 0, 0, 0);
    }
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, java.lang.String value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, java.lang.String value) {
      checkBounds(i, j, k);
      _set(i, j, k, 0, 0, 0, 0, value);
    }
    ...
    public java.lang.String[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new java.lang.String[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new java.lang.String[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
  ...
  /**
   * Define a four dimensional array of type <code>java.lang.String</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array4 extends Array {
     ...
     * index out of range exception will be thrown if the bounds are invalid.
     */
    public Array4(java.lang.String[][][][] array) {
      super();
      fromArray(array);
    }
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public java.lang.String _get(int i, int j, int k, int l) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public java.lang.String get(int i, int j, int k, int l) {
      checkBounds(i, j, k, l);
      return _get(i, j, k, l, 0, 0, 0);
    }
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, java.lang.String value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, int l, java.lang.String value) {
      checkBounds(i, j, k, l);
      _set(i, j, k, l, 0, 0, 0, value);
    }
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new java.lang.String[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new java.lang.String[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
 ...
 /**
   * Define a five dimensional array of type <code>java.lang.String</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array5 extends Array {
     ...
     * index out of range exception will be thrown if the bounds are invalid.
     */
    public Array5(java.lang.String[][][][][] array) {
      super();
      fromArray(array);
    }
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public java.lang.String _get(int i, int j, int k, int l, int m) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public java.lang.String get(int i, int j, int k, int l, int m) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, java.lang.String value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, int l, int m, java.lang.String value) {
      checkBounds(i, j, k, l, m);
      _set(i, j, k, l, m, 0, 0, value);
    }
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new java.lang.String[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
		array[i][j][k][l] = new java.lang.String[u4-l4+1];
		for (int m = l4; m <= u4; m++) {
...
/**
   * Define a six dimensional array of type <code>java.lang.String</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array6 extends Array {
     ...
     * index out of range exception will be thrown if the bounds are invalid.
     */
    public Array6(java.lang.String[][][][][][] array) {
      super();
      fromArray(array);
    }
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public java.lang.String _get(int i, int j, int k, int l, int m, int n) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public java.lang.String get(int i, int j, int k, int l, int m, int n) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, int n, java.lang.String value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, int l, int m, int n, java.lang.String value) {
      checkBounds(i, j, k, l, m, n);
      _set(i, j, k, l, m, n, 0, value);
    }
	...
	int l5 = _lower(5);
		...
		array[i][j][k] = new java.lang.String[u3-l3+1][][];
		  ...
		  array[i][j][k][l] = new java.lang.String[u4-l4+1][];
		for (int m = l4; m <= u4; m++) {
		    array[i][j][k][l][m] = new java.lang.String[u4-l4+1];
		    for (int n = l5; n <= u5; n++) {
...
/**
   * Define a seven dimensional array of type <code>java.lang.String</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array7 extends Array {
     ...
     * index out of range exception will be thrown if the bounds are invalid.
     */
    public Array7(java.lang.String[][][][][][][] array) {
      super();
      fromArray(array);
    }
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public java.lang.String _get(int i, int j, int k, int l, int m, int n, int o) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public java.lang.String get(int i, int j, int k, int l, int m, int n, int o) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, int n, int o, java.lang.String value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, int l, int m, int n, int o, java.lang.String value) {
      checkBounds(i, j, k, l, m, n, o);
	...
	int l6 = _lower(6);
		...
		for (int m = l4; m <= u4; m++) {
		  array[i][j][k][l][m] = new java.lang.String[u4-l4+1][];
		  for (int n = l5; n <= u5; n++) {
		    array[i][j][k][l][m][n] = new java.lang.String[u5-l5+1];
		    for (int o = l6; o <= u6; o++) {
