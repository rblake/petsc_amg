...
//  
//   THIS CLASS, IS AUTOGENERATED BY enum-gen.py
 ...
 * types.
 */
public class Enum extends sidl.Integer {
  /**
   ...
   */
  public static class Array extends sidl.Integer.Array {
    /*
     ...
     * instructions
     */
    public sidl.Integer.Array _slice(int dimen, int[] numElem, int[] srcStart,
			int[] srcStride, int[] newStart) {
      sidl.Integer.Array preCast = null;
      preCast = (sidl.Integer.Array) super._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return (sidl.Integer.Array)new sidl.Enum.Array(preCast.get_ior_pointer(), true);
    }

    /**
     * copies the elements from this array to dest.  ARRAYS MUST BE THE SAME SIZE.
     */
    public void _copy(sidl.Enum.Array dest) {
	super._copy((sidl.Integer.Array) dest);
    }

    
    public sidl.Integer.Array _dcast() {
      try{
        int dimen = _dim();
        sidl.Enum.Array ret = null;
        switch (dimen) {
        case 1: 
          _addRef();  
          ret = (Array) new sidl.Enum.Array1(get_ior_pointer(),true);
          return ret;
        case 2:
          _addRef();  
          ret = (Array) new sidl.Enum.Array2(get_ior_pointer(),true);
          return ret;
        case 3:
          _addRef();  
          ret = (Array) new sidl.Enum.Array3(get_ior_pointer(),true);
          return ret;
        case 4:
          _addRef();  
          ret = (Array) new sidl.Enum.Array4(get_ior_pointer(),true);
          return ret;
        case 5:
          _addRef();  
          ret = (Array) new sidl.Enum.Array5(get_ior_pointer(),true);
          return ret;
        case 6:
          _addRef();  
          ret = (Array) new sidl.Enum.Array6(get_ior_pointer(),true);
          return ret;
        case 7:
          _addRef();  
          ret = (Array) new sidl.Enum.Array7(get_ior_pointer(),true);
          return ret;
        default:
          return null;
        }
   ...
   */
   public Array1 smartCopy() {
     gov.llnl.sidl.BaseArray ba = _smartCopy();
     long ptr = ba.get_ior_pointer();
     sidl.Enum.Array ret = new sidl.Enum.Array(ptr,true);
     return (Array1) ret._dcast();
   }
