...
/**
 * Class <code>Long</code> contains inner classes that
...
public class Long {
  ...
  public static class Array extends gov.llnl.sidl.BaseArray {
     ...
     */
    static {
      gov.llnl.sidl.BaseClass._registerNatives("sidl.Long");
    }
  ...
  public Array _dcast() {
    try{ 
      int dimen = _dim();
      sidl.Long.Array ret = null;
      switch (dimen) {
      case 1: 

	ret = (Array) new sidl.Long.Array1(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 2:
        ret = (Array) new sidl.Long.Array2(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 3:
        ret = (Array) new sidl.Long.Array3(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 4:
        ret = (Array) new sidl.Long.Array4(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 5:
        ret = (Array) new sidl.Long.Array5(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 6:
        ret = (Array) new sidl.Long.Array6(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 7:
        ret = (Array) new sidl.Long.Array7(get_ior_pointer(),true);
         _addRef();
        return ret;
      default:
        return null;
