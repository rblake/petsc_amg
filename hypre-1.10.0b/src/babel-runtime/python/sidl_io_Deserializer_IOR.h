 ...
 * Revision:      @(#) $Id: sidl_io_Deserializer_IOR.h,v 1.4 2005/11/14 21:20:12 painter Exp $
...
#define included_sidl_io_Deserializer_IOR_h
...
struct sidl_io_Deserializer__object {
  struct sidl_io_Deserializer__epv* d_epv;
  void*                             d_object;
};
...
struct sidl_io__Deserializer__array;
struct sidl_io__Deserializer__object;

/*
 * Declare the method entry point vector.
 */

struct sidl_io__Deserializer__epv {
  /* Implicit builtin methods */
  void* (*f__cast)(
...
struct sidl_io__Deserializer__object {
  ...
  struct sidl_io__Deserializer__epv*  d_epv;
  void*                               d_data;
};
