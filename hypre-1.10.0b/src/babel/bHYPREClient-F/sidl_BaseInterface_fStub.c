 ...
 * Revision:      @(#) $Id: sidl_BaseInterface_fStub.c,v 1.33 2005/12/15 00:36:07 painter Exp $
 ...
 * 
 * babel-version = 0.10.4
 * xml-url       = /home/painter/babel-0.10.4/bin/.././share/repository/sidl.BaseInterface-v0.9.3.xml
 */
...
void
SIDLFortran77Symbol(sidl_baseinterface__cast2_f,SIDL_BASEINTERFACE__CAST2_F,sidl_BaseInterface__cast2_f)
(
  int64_t *self,
...
void
SIDLFortran77Symbol(sidl_baseinterface_getclassinfo_f,SIDL_BASEINTERFACE_GETCLASSINFO_F,sidl_BaseInterface_getClassInfo_f)
(
  int64_t *self,
  int64_t *retval
)
...
void
SIDLFortran77Symbol(sidl_baseinterface__array_get5_f,
                  SIDL_BASEINTERFACE__ARRAY_GET5_F,
                  sidl_BaseInterface__array_get5_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(sidl_baseinterface__array_get6_f,
                  SIDL_BASEINTERFACE__ARRAY_GET6_F,
                  sidl_BaseInterface__array_get6_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(sidl_baseinterface__array_get7_f,
                  SIDL_BASEINTERFACE__ARRAY_GET7_F,
                  sidl_BaseInterface__array_get7_f)
  (int64_t *array, 
   int32_t *i1, 
   int32_t *i2, 
...
void
SIDLFortran77Symbol(sidl_baseinterface__array_set5_f,
                  SIDL_BASEINTERFACE__ARRAY_SET5_F,
                  sidl_BaseInterface__array_set5_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(sidl_baseinterface__array_set6_f,
                  SIDL_BASEINTERFACE__ARRAY_SET6_F,
                  sidl_BaseInterface__array_set6_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(sidl_baseinterface__array_set7_f,
                  SIDL_BASEINTERFACE__ARRAY_SET7_F,
                  sidl_BaseInterface__array_set7_f)
  (int64_t *array,
   int32_t *i1,
   int32_t *i2,
...
void
SIDLFortran77Symbol(sidl_baseinterface__array_length_f,
                  SIDL_BASEINTERFACE__ARRAY_LENGTH_F,
                  sidl_BaseInterface__array_length_f)
  (int64_t *array,
   int32_t *ind,
   int32_t *result)
...
void
SIDLFortran77Symbol(sidl_baseinterface__array_slice_f,
                  SIDL_BASEINTERFACE__ARRAY_SLICE_F,
                  sidl_BaseInterface__array_slice_f)
  (int64_t *src,
   int32_t *dimen,
   int32_t numElem[],
