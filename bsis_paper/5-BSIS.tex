\chapter{Bucket Sorted Independent Sets}
\label{chap:BSIS}
...
\begin{figure}
  \begin{center}
    %\includegraphics[width=0.8\textwidth]{images/5/bucket-algorithm.eps}
    \includegraphics[width=0.98\textwidth]{images/5/BSIS/initial.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.98\textwidth]{images/5/BSIS/cp1.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.98\textwidth]{images/5/BSIS/cp1-agg.eps}
    \caption{The BSIS data structure after selecting the first
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.75\textwidth]{images/5/agg-no-scaling.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.98\textwidth]{images/5/BSIS/cp1p.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.98\textwidth]{images/5/BSIS/cp2p.eps}
    \caption{The painted boundary method with aggregate weight
